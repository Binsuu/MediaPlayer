   ...
   public static class GradeFour
    {
        ...
        public static List<Subjects> GetSubjects()
        {
            ...
            Subjects.Add(new Subjects { subject = "Social", units = getSocialUnits() });
             Subjects.Add(new Subjects { subject = "Science", units = getScienceUnits() });
            Subjects.Add(new Subjects { subject = "Maths", units = getMathsUnits() });
            return Subjects;
        ...
        //{
        //    List<Topics> topics = new List<Topics>();
        //    topics.Add(new Topics( "i. Occupation Of My Neighbours", false,false,false,false,false,false,false,false,false,false,false) { animations=  GetAnimations() });
        //    units.Add(new Units("1. Occupation Of My Neighbours") { Title = "Occupation Of My Neighbours", ListItems = topics });


        //    topics = new List<Topics>();
        //    topics.Add(new Topics("i. Social Responsibility", false, false, false, false, false, false, false, false, false, false, false) { animations=  GetAnimations() });
        //    topics.Add(new Topics("ii. Good Behaviour", false, false, false, false, false, false, false, false, false, false, false) { animations=  GetAnimations() });
        //    topics.Add(new Topics("iii. People Become Great By Heart", false, false, false, false, false, false, false, false, false, false, false) { animations=  GetAnimations() });
        //    topics.Add(new Topics("iv. Feel The Pain Of Others", false, false, false, false, false, false, false, false, false, false, false) { animations=  GetAnimations() });
        //    units.Add(new Units("2. Me and My Family") { Title = "2. Me and My Family", ListItems = topics });

        //    topics = new List<Topics>();
        //    topics.Add(new Topics("i. Our Traditions, Social Values And Norms", false, false, false, false, false, false, false, false, false, false, false) { animations=  GetAnimations() });
        //    topics.Add(new Topics("ii. Our Glorious Traditions", false, false, false, false, false, false, false, false, false, false, false) { animations=  GetAnimations() });
